...
public class OpenHelper extends OrmLiteSqliteOpenHelper {
    ...
    private Dao<ChooseCityInfo, Integer> mChooseCityInfoDao;
    ...
    private void createTable() {
        try {
            TableUtils.createTableIfNotExists(connectionSource, ChooseCityInfo.class);
    ...
    public Dao<ChooseCityInfo, Integer> getChooseCityInfoDao() {
        if (mChooseCityInfoDao == null) {
            try {
                mChooseCityInfoDao = getDao(ChooseCityInfo.class);
            } catch (SQLException e) {
                return null;
            }
        }
        return mChooseCityInfoDao;
    }
}
